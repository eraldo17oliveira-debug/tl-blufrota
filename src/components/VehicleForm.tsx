    ...
    <div className="glass-card rounded-2xl p-5 space-y-5">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <OptionGroup label="Eixos" value={eixo} onChange={setEixo}
          colorClass="bg-[hsl(var(--neon-purple))] text-foreground"
          glowClass="shadow-[0_0_12px_hsl(var(--neon-purple)/0.5)]"
          options={[
        ...
        <OptionGroup label="Carga" value={estado} onChange={setEstado}
          colorClass="bg-[hsl(var(--neon-orange))] text-primary-foreground"
          glowClass="shadow-[0_0_12px_hsl(var(--neon-orange)/0.5)]"
        ...
        <OptionGroup label="Segurança" value={status} onChange={setStatus}
          ...
          glowClass="shadow-[0_0_12px_hsl(var(--destructive)/0.5)]"
          options={[
